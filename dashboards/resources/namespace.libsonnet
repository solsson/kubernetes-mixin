    ...
    'k8s-resources-namespace.json':
      ...
      .addRow(
        ...
        .addPanel(
          ...
          g.statPanel('sum(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_rate{%(clusterLabel)s="$cluster", namespace="$namespace"}) / sum(kube_pod_container_resource_requests_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="cpu"})' % $._config)
        )
        .addPanel(
          g.panel('CPU Utilisation (from limits)') +
          g.statPanel('sum(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_rate{%(clusterLabel)s="$cluster", namespace="$namespace"}) / sum(kube_pod_container_resource_limits_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="cpu"})' % $._config)
        )
        .addPanel(
          g.panel('Memory Utilization (from requests)') +
          g.statPanel('sum(container_memory_working_set_bytes{%(clusterLabel)s="$cluster", namespace="$namespace",container!="", image!=""}) / sum(kube_pod_container_resource_requests_memory_bytes{namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="memory"})' % $._config)
        )
        .addPanel(
          g.panel('Memory Utilisation (from limits)') +
          g.statPanel('sum(container_memory_working_set_bytes{%(clusterLabel)s="$cluster", namespace="$namespace",container!="", image!=""}) / sum(kube_pod_container_resource_limits_memory_bytes{namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="memory"})' % $._config)
        )
      )
      .addRow(
        g.row('CPU Usage')
      ...
      .addRow(
        ...
        .addPanel(
          ...
          g.tablePanel([
            ...
            'sum(kube_pod_container_resource_requests_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="cpu"}) by (pod)' % $._config,
            'sum(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_rate{%(clusterLabel)s="$cluster", namespace="$namespace"}) by (pod) / sum(kube_pod_container_resource_requests_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="cpu"}) by (pod)' % $._config,
            'sum(kube_pod_container_resource_limits_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="cpu"}) by (pod)' % $._config,
            'sum(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_rate{%(clusterLabel)s="$cluster", namespace="$namespace"}) by (pod) / sum(kube_pod_container_resource_limits_cpu_cores{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="cpu"}) by (pod)' % $._config,
          ], tableStyles {
      ...
      .addRow(
        ...
        .addPanel(
          ...
          g.tablePanel([
            ...
            'sum(kube_pod_container_resource_requests_memory_bytes{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="memory"}) by (pod)' % $._config,
            'sum(container_memory_working_set_bytes{%(clusterLabel)s="$cluster", namespace="$namespace",container!="", image!=""}) by (pod) / sum(kube_pod_container_resource_requests_memory_bytes{namespace="$namespace"} OR kube_pod_container_resource_requests{namespace="$namespace", resource="memory"}) by (pod)' % $._config,
            'sum(kube_pod_container_resource_limits_memory_bytes{%(clusterLabel)s="$cluster", namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="memory"}) by (pod)' % $._config,
            'sum(container_memory_working_set_bytes{%(clusterLabel)s="$cluster", namespace="$namespace",container!="", image!=""}) by (pod) / sum(kube_pod_container_resource_limits_memory_bytes{namespace="$namespace"} OR kube_pod_container_resource_limits{namespace="$namespace", resource="memory"}) by (pod)' % $._config,
